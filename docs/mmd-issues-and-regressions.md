...
### 1. Display Preview Cache Generating Empty Image
...
### 2. Built-in VMD Motions Missing in ModelCustomizer
...
### 3. Bundled Model Backup Architecture Clobbered (Flat Filesystem Degradation)
