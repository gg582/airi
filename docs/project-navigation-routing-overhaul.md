...
| TBD | Router Guard | Add `meta.rootOfSettings` and global `beforeEach` guard. | ⏳ Pending |
| TBD | Window Titles | Standardize titles to `AIRI — {Window}` & wire IPC title sync. | ⏳ Pending |
