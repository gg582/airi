...
// Generate SVG header-track scene with full width
...
<template>
  <header class="border-b border-neutral-200/80 pb-5 pt-2 space-y-4 dark:border-neutral-800/80">
    <!-- ── Top: Minimalist Hairline Header-Track ── -->
    ...
    <!-- ── Bottom: Page Title & Right-Aligned Kanji Watermark ── -->
